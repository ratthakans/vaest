import { SB, svcHeaders, PLANS, INTERNAL, INVITED, PLAN_MAP, isInternal } from './plans.js';
...
export async function resolveAccess(email) {
  ...
  if (isInternal(e)) return { allowed: true, internal: true, source: 'internal', plan: { name: 'unlimited', ...PLANS.unlimited } };
