...
export const PLANS = {
  basic:     { docs: 20,  refine: false, refineMonth: 0   },
  pro:       { docs: 60,  refine: true,  refineMonth: 60  },
  director:  { docs: 120, refine: true,  refineMonth: 120 },
  unlimited: { docs: Infinity, refine: true, refineMonth: Infinity },
};
